        ...
        <div class="w-full lg:w-6/12 h-full bg-orange-100 hidden md:flex">
            <div class="w-full h-full relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    @else
                        <img src="{{ asset('images/logo.png') }}" alt="" class="h-20 md:h-32 object-contain">
                    @endif
                </div>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('user.register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" type="text" placeholder="Your name" name="name"
                            ...
                            class="w-full px-4 py-2 border @error('name')
                             border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                        @error('name')
