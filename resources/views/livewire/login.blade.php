    ...
    <div class="w-full  bg-white flex flex-col md:flex-row overflow-hidden">
        ...
        <div class="w-full md:w-6/12 hidden md:flex">
            <div class="w-full overflow-hidden">
                <img src="https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="object-cover hidden md:block w-full" alt="New Background Image">
            </div>
        </div>
