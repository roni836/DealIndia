    ...
    <div class="w-full max-w-md p-6">
        ...
        <form action="{{ route('user.investerCodecheck') }}" method="POST" class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="vr_code" name="vr_code" value="{{ old('vr_code') }}" placeholder="Enter VR Code"
            ...
            <div class="mb-5">
                ...
                <input type="text" id="range_code" name="range_code" value="{{ old('range_code') }}" placeholder="Enter Range Code"
                    class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                @error('range_code')
                <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input type="text" id="company_code" name="company_code" value="{{ old('company_code') }}" placeholder="Enter Company Code"
                    class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                @error('company_code')
                <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input type="text" id="noc_number" name="noc_number" value="{{ old('noc_number') }}" placeholder="Enter NOC Number"
                    class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                @error('noc_number')
                <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
