    ...
    <div class="md:w-1/4">
      <div class="sticky top-8 bg-white rounded-lg shadow-lg p-6">
        ...
        <nav>
          <ul class="space-y-2">
            <li>
              <button onclick="scrollToSection('collect')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-user-shield mr-2"></i>
                <span>Information We Collect</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('use')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-database mr-2"></i>
                <span>How We Use Your Information</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('share')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-share mr-2"></i>
                <span>Sharing Your Information</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('security')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-key mr-2"></i>
                <span>Data Security</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('rights')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-lock mr-2"></i>
                <span>Your Rights and Choices</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('cookies')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-cookie mr-2"></i>
                <span>Cookies and Tracking</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('changes')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
                <i class="fas fa-exclamation-circle mr-2"></i>
                <span>Changes to Policy</span>
              </button>
            </li>
            <li>
              <button onclick="scrollToSection('contact')" class="flex items-center w-full p-2 rounded-md transition-colors hover:bg-gray-100">
