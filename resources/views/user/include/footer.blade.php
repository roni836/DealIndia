<footer class="bg-blue-900 text-white py-8">
    <div class="w-full">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[2fr,1fr,1fr,1fr] gap-8">
                <div class="flex flex-col items-center sm:items-start md:items-start">
                    <img src="logo.png" alt="Logo" class="h-12 mb-4">
                    <p class="text-sm text-center sm:text-left md:text-left">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-sm">Email: info@dealindia.com</p>
                    </div>
                </div>
        ...
        <div class="border-t border-gray-500 py-4 mt-8">
            <div class="max-w-screen-xl mx-auto text-center">
                <p class="text-sm"> &copy; {{ date('Y') }} Deal India. All rights reserved. </p>
            </div>
        </div>
    </div>
</footer>
