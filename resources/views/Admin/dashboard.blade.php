            ...
            <table class="w-full text-left table-auto">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="px-4 py-2">
                            <button class="text-blue-600 hover:underline bg-blue-100 px-3 py-1 rounded">View</button>
                            <button class="text-red-600 hover:underline bg-red-100 px-3 py-1 rounded ml-2">Reject</button>
                        </td>
                    </tr>
                    <tr>
